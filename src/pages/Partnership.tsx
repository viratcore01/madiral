...
import { formSubmitAction, thanksUrl } from "@/lib/formSubmit";
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        >
          ...
          <form action={formSubmitAction} method="POST" className="space-y-6">
            {/* FormSubmit controls */}
            <input type="hidden" name="_subject" value="New partnership submission" />
